...
public class AchievementRegistry {
    ...
    private static Achievement blue = new DemoAchievement("demo.blue", "Blue", 0, 0, Blocks.wool, null) {
    ...
    private static Achievement red = new DemoAchievement("demo.red", "Red", 2, -1, Blocks.wool, blue) {
    ...
    private static Achievement rainbow = new DemoAchievement("demo.rainbow", "Rainbow", 2, 1, Items.nether_star, red) {
    ...
    private static AchievementPage page1 = new DemoPage("demoPage1", blue, red, rainbow) {
    ...
    private static AchievementPage page2 = new DemoPage("demoPage2", blue, red, rainbow) {
    ...
    private static AchievementPage page3 = new DemoPage("demoPage3", blue, red, rainbow) {
    ...
    private static AchievementPage page4 = new DemoPage("demoPage4", blue, red, rainbow) {
    ...
    private static AchievementPage page5 = new AchievementPage("demoPage5", blue, red, rainbow);
