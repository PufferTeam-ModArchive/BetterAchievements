...
public interface ICustomArrows {
     ...
     * {@link betterachievements.api.util.ColourHelper#RGB(String)} to use #RRGGBB format to integer
     *
    ...
    /**
     * The integer value of the arrow for achievements that can't be unlocked yet Use
     * {@link betterachievements.api.util.ColourHelper#RGB(String)} to use #RRGGBB format to integer
     *
     * @return the integer value of the arrow
     */
