...
public interface ICustomBackground {
    ...
    /**
     * Drawing the background of the achievement page This is called after translating the origin to the top left corner
     * of the background area NOTE: You need to do your own scaling
     *
