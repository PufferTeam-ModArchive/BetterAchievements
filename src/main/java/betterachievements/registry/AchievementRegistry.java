...
public final class AchievementRegistry {
    ...
    private void init() {
        for (Object oa : AchievementList.achievementList) {
            ...
            if (!AchievementPage.isAchievementInPages(achievement)) this.mcAchievements.add(achievement);
        }
    ...
    public ItemStack getItemStack(AchievementPage page) {
        ...
        if (itemStack == null) {
            if (page instanceof ICustomIcon) itemStack = ((ICustomIcon) page).getPageIcon();
            if (itemStack == null) {
    ...
    public void registerIcon(String pageName, ItemStack itemStack, boolean userSet) {
        ...
        if (userSet) this.userSetIcons.put(pageName, itemStack);
    }
    ...
    public void setUserSetIcons(String[] array) {
        ...
        for (String entry : array) {
            ...
            if (item != null) itemStack = new ItemStack(item, 0, meta);
            if (itemStack != null) {
